...
chocolate_part2 = countries_with_enough_reviews %>%
  ...
  mutate(continent = case_when(
    country_of_bean_origin %in% c("Fiji", "Papua New Guinea", "Vanuatu", "Solomon Islands") & is.na(continent) ~ "Australia",
    country_of_bean_origin %in% c("Sao Tome", "Congo") & is.na(continent) ~ "Africa",
    country_of_bean_origin %in% c("Trinidad", "Belize", "Grenada", "St. Lucia", "U.S.A.") & is.na(continent) ~ "Americas",
...
ggplot(chocolate_part2, aes(x = continent, y = rating)) + geom_violin() +
